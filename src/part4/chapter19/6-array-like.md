...
[MDN's typed array guide](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Typed_arrays) covers them in detail. For most application code, regular arrays are sufficient.
